...
local w = library:Window("Free2Play Hub", "ABT", Color3.fromRGB(66, 134, 245), Enum.KeyCode.LeftControl)
...
HomeTab:Button("Script by Free2Play Hub","", function()
	library:Notification("Hi", "Alright")
end)
